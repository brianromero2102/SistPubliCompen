...
@Component({
  selector: 'app-maintenance-technology',
  templateUrl: './maintenance-technology.component.html',
  styleUrls: ['./maintenance-technology.component.scss']
})
export class MaintenanceTechnologyComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_technology,
        itemAlias: 'file',
        queueLimit: 10,
    });
