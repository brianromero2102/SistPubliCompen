...
@Component({
    selector: 'app-maintenance-places',
    templateUrl: './maintenance-places.component.html',
    styleUrls: ['./maintenance-places.component.scss']
})
export class MaintenancePlacesComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_delivery,
        itemAlias: 'file',
        queueLimit: 10,
    });
