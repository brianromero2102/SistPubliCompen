...
@Component({
    selector: 'app-maintenance-employee',
    templateUrl: './maintenance-employee.component.html',
    styleUrls: ['./maintenance-employee.component.scss']
})
export class MaintenanceEmployeeComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_employee,
        itemAlias: 'file',
        queueLimit: 10,
    });
