...
@Component({
  selector: 'app-maintenance-stock',
  templateUrl: './maintenance-stock.component.html',
  styleUrls: ['./maintenance-stock.component.scss']
})
export class MaintenanceStockComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_stock,
        itemAlias: 'file',
        queueLimit: 10,
    });
