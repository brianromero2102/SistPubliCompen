...
@Component({
  selector: 'app-maintenance-type-reccesed',
  templateUrl: './maintenance-type-reccesed.component.html',
  styleUrls: ['./maintenance-type-reccesed.component.scss']
})
export class MaintenanceTypeReccesedComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_typereccessed,
        itemAlias: 'file',
        queueLimit: 10,
    });
