...
@Component({
    selector: 'app-maintenance-backoffice',
    templateUrl: './maintenance-backoffice.component.html',
    styleUrls: ['./maintenance-backoffice.component.scss']
})
export class MaintenanceBackofficeComponent implements OnInit {

    formMaintenance: FormGroup;
    user: IAuthTokenInformation;

    uploader: FileUploader = new FileUploader({
        url: UploadEndpoint.uri_upload_backoffice,
        itemAlias: 'file',
        queueLimit: 10,
    });
